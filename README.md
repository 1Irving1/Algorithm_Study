...
코딩테스트 대비 알고리즘 문제 풀이 저장소입니다. 문제 유형별 폴더에 풀이를 정리하고, 아래 표에 풀이 기록을 누적합니다.

## 폴더 구조

문제 유형별 폴더 안에 `{사이트}_{문제명}.java` 형식으로 파일을 저장합니다.

예: `완전탐색/프로그래머스_체육대회.java`

## 풀이 기록

| 날짜 | 문제 | 사이트 | 유형 | 링크 |
| --- | --- | --- | --- | --- |
| 2026-08-21 | 모음사전 | 프로그래머스 | 완전탐색 | [link](https://school.programmers.co.kr/learn/courses/30/lessons/84512) |
...
| 2026-08-05 | 가장 먼 노드 | 프로그래머스 | DFS_BFS | [link](https://school.programmers.co.kr/learn/courses/30/lessons/49189) |
...
| 2026-07-08 | [PCCP 모의고사 #1] 2번 - 체육대회 | 프로그래머스 | 완전탐색 | [link](https://school.programmers.co.kr/learn/courses/15008/lessons/121684) |
| 2026-07-08 | [PCCP 모의고사 #1] 1번 - 외톨이 알파벳 | 프로그래머스 | 구현 | [link](https://school.programmers.co.kr/learn/courses/15008/lessons/121683) |
